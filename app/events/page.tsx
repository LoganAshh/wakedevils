    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow max-w-4xl mx-auto px-4 py-8 md:py-8 w-full">
          {/* DESKTOP content */}
          <div
            className={`hidden md:block transition-opacity duration-700 ${
          ...
          {/* MOBILE content */}
          <div
            className={`md:hidden flex flex-col justify-start pt-6 pb-8 gap-y-8 transition-opacity duration-700 ${
              loaded ? "opacity-100" : "opacity-0"
            }`}
          >
